...
class _AppointmentListScreenState extends State<AppointmentListScreen> {
        ...
        setState(() {
          appointments = appointmentMaps.map((map) {
            return Appointment(
              ...
              appointmentDate: DateTime.tryParse(map['appointmentDate'] ?? '') ?? DateTime.now(),
  ...
  Future<void> _showAppointmentForm({Appointment? appointment}) async {
    ...
    DateTime appointmentDate = appointment?.appointmentDate ?? DateTime.now();
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: appointmentDate.toLocal().toString().split(' ')[0],
                  ),
                  onTap: () async {
